...
const About = () => {
  ...
  const capabilities = ["Advanced LDPE Film Extrusion Technology", "Multi-Layer Co-Extrusion Capabilities", "Automated Bag Making & Converting Lines", "Quality Control Laboratory & Testing", "Custom Color Matching & Formulation", "Flexible Production Scheduling", "Large Scale Manufacturing Capacity", "Food grade & Pharma grade materials"];
  const milestones = [{
    year: "2005",

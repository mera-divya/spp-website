...
const About = () => {
  ...
  const capabilities = ["Advanced LDPE Film Extrusion Technology", "custom color & flexible sizing", "Automated Bag Making & Converting Lines", "Quality Control Laboratory & Testing", "Multiple thickness options", "Batch coding & labeling", "Large Scale Manufacturing Capacity", "Food grade & Pharma grade materials"];
  const milestones = [{
    year: "2005",
